...
agent_communication:
  ...
  - agent: "main"
    message: "GPay-style Split UI + Settlement Gamification + AI Money School. New: POST /api/split/settle-with-rewards, GET /api/split/settlement-leaderboard, POST /api/split/redeem-coins, GET /api/money-school/personalized, POST /api/split/expenses/recurring. Split has 4 split types (equal/amount/shares/percentage), member toggle, reward coins, settlement celebration modal. Auth: 9876543210/123456."
  - agent: "testing"
