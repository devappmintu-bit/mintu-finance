...
agent_communication:
  ...
  - agent: "main"
    message: "ALL ObjectId fixes applied. Settle, settlements, nudges now handle non-ObjectId user IDs gracefully. Splitwise Pro with group summaries, simplified debts, recurring expenses, UPI payment with app selector. Money School gamification with 12 cards, XP, levels. Test all 30+ endpoints. Auth: 9876543210/123456."
  - agent: "testing"
