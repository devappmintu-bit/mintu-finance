...
agent_communication:
  ...
  - agent: "main"
    message: "SPLIT SECTION COMPLETE REWRITE: (1) Auto-create placeholder users for unregistered phones (2) Multi-member add via comma-separated phones (3) Group management modal with avatar stack, admin badges, invite link, leave group (4) GPay-style expense modal with 4 split types (5) Settlement leaderboard with coins. Created 8 test users for testing. Auth: 9876543210/123456."
  - agent: "testing"
