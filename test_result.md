...
agent_communication:
  ...
  - agent: "main"
    message: "MAJOR UPGRADE: Splitwise Pro (group summaries, simplified debts, recurring expenses, UPI payment flow with app selector, payment confirmation), Money School gamification (12 cards, XP, levels, streaks), UPI app selector modal. Auth: 9876543210/123456. Test ALL: /split/groups/{id}/summary, /split/expenses/recurring, /money-school/cards, /money-school/complete, /upi/apps, /upi/generate-qr."
  - agent: "testing"
  ...
  - agent: "testing"
    message: "✅ COMPREHENSIVE PRODUCTION TESTING COMPLETED - 25/30 ENDPOINTS PASSED (83.3% SUCCESS RATE)! WORKING: OTP auth flow ✅, user profile ✅, UPI save/retrieve ✅, split groups creation/listing ✅, group summary ✅, split balances ✅, recurring expenses ✅, money school cards (12 cards) ✅, UPI apps (4 apps) ✅, QR generation ✅, pay intent ✅, AI agent chat ✅, AI agents list (5 agents) ✅, transactions (43) ✅, budgets (6) ✅, stats overview ✅, leaderboard ✅, waste detector ✅, smart alerts (6) ✅, share stats ✅. FAILED (5): split expense creation (response format), group expenses (wrapped response), settle payment (500 error), settlements history (500 error), proactive nudges (500 error). Rate limiting 300/min working. Backend mostly production-ready with minor fixes needed."
