...
const useStyles = makeStyles((c) => ({
  ...
  emojiWrap: { width: 32, height: 32, borderRadius: 0, backgroundColor: c.accent.primary + '15', justifyContent: 'center', alignItems: 'center' },
  ...
  stackAvatar: { width: 28, height: 28, borderRadius: 0, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: c.bg.card },
