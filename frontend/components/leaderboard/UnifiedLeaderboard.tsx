...
const useStyles = makeStyles((c) => ({
  card: { backgroundColor: '#FFFBEB', borderRadius: 0, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#FDE68A' },
  ...
  meBar: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 0, padding: 12, marginBottom: 14, gap: 4 },
  ...
  row: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 6, borderRadius: 0 },
  ...
  avatar: { width: 32, height: 32, borderRadius: 0, backgroundColor: c.accent.primary + '20', justifyContent: 'center', alignItems: 'center' },
