...
const useStyles = makeStyles((c) => ({
  ...
  aiPill: { backgroundColor: c.accent.primary, paddingHorizontal: 7, paddingVertical: 2, borderRadius: 0 },
  aiPillTxt: { color: c.bg.elevated, fontSize: 9, fontWeight: '900', letterSpacing: 0.4 },
  tabRow: { flexDirection: 'row', gap: 4, padding: 4, backgroundColor: c.gray[100], borderRadius: 0, marginBottom: 12 },
  tab: { flex: 1, paddingVertical: 7, paddingHorizontal: 10, borderRadius: 0, alignItems: 'center' },
  ...
  predictRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, paddingHorizontal: 10, backgroundColor: c.state.warningBg, borderRadius: 0, borderWidth: 1, borderColor: c.state.warningBorder },
  ...
  wasteRow: { flexDirection: 'row', gap: 10, alignItems: 'flex-start', paddingVertical: 10, paddingHorizontal: 10, backgroundColor: c.accent.brandSoft, borderRadius: 0, borderLeftWidth: 3, borderLeftColor: c.accent.primary },
