...
const useStyles = makeStyles((c) => ({
  ...
  saverPill: { backgroundColor: c.state.danger, paddingHorizontal: 6, paddingVertical: 1, borderRadius: 999 },
  saverTxt: { fontSize: 8, fontWeight: '900', color: c.bg.elevated, letterSpacing: 0.4 },
