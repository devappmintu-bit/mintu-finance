...
const s = StyleSheet.create({
  ...
  proBadge: { backgroundColor: '#FCD34D', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 0 },
  proBadgeTxt: { fontSize: 9.5, fontWeight: '900', color: '#0F172A', letterSpacing: 0.7 },
  urgencyBadge: { backgroundColor: '#EF444422', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 0, borderWidth: 1, borderColor: '#EF444488' },
