...
const s = StyleSheet.create({
  ...
  title: { fontSize: 18, fontWeight: '900', color: '#111827', textAlign: 'center', marginBottom: 6 },
  sub: { fontSize: 12.5, color: '#6B7280', lineHeight: 17, textAlign: 'center', marginBottom: 6 },
  body: { fontSize: 12.5, color: '#6B7280', lineHeight: 18, textAlign: 'center', marginBottom: 14 },
  input: { backgroundColor: '#F9FAFB', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 11, fontSize: 14, color: '#111827', borderWidth: 1.5, borderColor: '#FCA5A5', letterSpacing: 2, fontWeight: '900' },
  actions: { flexDirection: 'row', gap: 10, marginTop: 16 },
  btn: { flex: 1, paddingVertical: 12, borderRadius: 12, alignItems: 'center' },
  btnGhost: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#E5E7EB' },
  btnDanger: { backgroundColor: '#EF4444' },
  btnT: { fontSize: 14, fontWeight: '800' },
  cancelBtn: { marginTop: 12, paddingVertical: 13, borderRadius: 999, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center' },
  ...
  dangerZone: { marginTop: 14, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#E5E7EB' },
  dangerZoneHeader: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 6 },
  dangerZoneLabel: { fontSize: 9.5, fontWeight: '900', color: '#EF4444', letterSpacing: 0.8 },
  ...
  dangerRowTxt: { flex: 1, fontSize: 12.5, fontWeight: '800', color: '#EF4444' },
  ...
  irreversibleTxt: { fontSize: 10, fontWeight: '900', color: '#EF4444', letterSpacing: 1 },
  typeHint: { fontSize: 12.5, color: '#6B7280', marginTop: 6, marginBottom: 6, fontWeight: '600', textAlign: 'center' },
