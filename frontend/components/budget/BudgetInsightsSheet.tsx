...
const useStyles = makeStyles((c) => ({
  ...
  sect: { fontSize: 10.5, fontWeight: '800', color: c.gray[400], textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 16, marginBottom: 8 },

  tagRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  tag: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 999, borderWidth: 1 },
  tagT: { fontSize: 11.5, fontWeight: '700' },

  tipRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: c.gray[100] },
  ...
  actBtn: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: c.accent.brandSoft, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 8, borderWidth: 1, borderColor: '#FED7AA' },
  actT: { flex: 1, fontSize: 13.5, fontWeight: '700', color: '#7C2D12' },

  statsBox: { flexDirection: 'row', marginTop: 16, backgroundColor: c.gray[50], borderRadius: 14, paddingVertical: 12, borderWidth: 1, borderColor: c.gray[200] },
  stat: { flex: 1, alignItems: 'center' },
  statV: { fontSize: 15, fontWeight: '800', color: c.text.primary },
  statL: { fontSize: 10, color: c.text.muted, fontWeight: '700', marginTop: 2, textTransform: 'uppercase', letterSpacing: 0.3 },
