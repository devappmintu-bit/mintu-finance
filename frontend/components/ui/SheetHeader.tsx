...
const s = StyleSheet.create({
  handle: { width: 40, height: 4, borderRadius: 2, backgroundColor: COLORS.gray[300], alignSelf: 'center', marginTop: 8, marginBottom: 8 },
  row: { flexDirection: 'row', alignItems: 'flex-start', paddingBottom: 12 },
  title: { fontSize: 19, fontWeight: '800', color: COLORS.text.primary, letterSpacing: -0.3 },
  sub: { fontSize: 12.5, fontWeight: '600', color: COLORS.text.secondary, marginTop: 3 },
  closeBtn: {
