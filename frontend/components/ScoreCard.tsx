...
const useStyles = makeStyles((c) => ({
  ...
  logoIcon: { width: 32, height: 32, borderRadius: 0, backgroundColor: COLORS.state.successAlt, justifyContent: 'center', alignItems: 'center' },
  ...
  scoreRing: { width: 120, height: 120, borderRadius: 0, borderWidth: 5, justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  ...
  statsRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 0, marginBottom: 16 },
  ...
  generalBtn: {
    width: 48, height: 48, borderRadius: 0, backgroundColor: c.bg.secondary,
