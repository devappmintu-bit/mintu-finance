...
const DOCS: Record<string, LegalDoc> = {
  ...
  terms: {
    ...
    sections: [
      ...
      { heading: '5. Subscription & Billing', body: 'MintU Premium uses an India-friendly pricing ladder capped at ₹150/month. Micro (₹29), Standard (₹99), and Premium (₹149) are all monthly subscriptions. Subscriptions auto-renew unless cancelled at least 24 hours before renewal. Refunds are governed by Play Store / App Store policies for in-app purchases. We reserve the right to change pricing with 30-day notice.' },
