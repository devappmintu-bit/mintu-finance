...
const useStyles = makeStyles((c) => ({
  ...
  chipsRow: { flexDirection: 'row', gap: 8, paddingHorizontal: 14, paddingVertical: 10, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
  chip: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, backgroundColor: '#F3F4F6' },
  chipOn: { backgroundColor: '#F56E1E' },
  chipTxt: { fontSize: 12, fontWeight: '700', color: '#6B7280' },
  chipTxtOn: { color: '#fff' },

  summaryCard: { backgroundColor: '#111827', borderRadius: 16, padding: 14, marginBottom: 14 },
  ...
  sumBody: { color: '#F9FAFB', fontSize: 13, lineHeight: 19 },

  kpiGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 14 },
  kpi: { width: '48%', padding: 10, borderRadius: 12, backgroundColor: '#fff', borderWidth: 1, position: 'relative', overflow: 'hidden' },
  kpiBar: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 4 },
  kpiLbl: { fontSize: 11, color: '#6B7280', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3, marginLeft: 4 },
  kpiVal: { fontSize: 18, fontWeight: '800', marginTop: 2, marginLeft: 4 },

  card: { backgroundColor: '#fff', borderRadius: 16, padding: 14, marginBottom: 14, borderWidth: 1, borderColor: '#F3F4F6' },
  cardTitle: { fontSize: 13, fontWeight: '800', color: '#111', letterSpacing: 0.2 },

  legendRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginTop: 6 },
  legendDot: { width: 10, height: 10, borderRadius: 5 },
  legendTxt: { marginLeft: 6, fontSize: 11, color: '#6B7280', fontWeight: '600' },

  thRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: '#F3F4F6', marginTop: 10 },
  th: { fontSize: 10, fontWeight: '800', color: '#6B7280', letterSpacing: 0.5, textTransform: 'uppercase' },
  tr: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#F9FAFB' },
  td: { fontSize: 13, color: '#111', flex: 1 },
  tdRight: { textAlign: 'right' },
  pctDot: { width: 10, height: 10, borderRadius: 5, marginRight: 8 },

  projectionBox: { flex: 1, padding: 12, borderRadius: 12, borderWidth: 1 },
  projLbl: { fontSize: 11, color: '#6B7280', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.3 },
  projVal: { fontSize: 18, fontWeight: '800', marginTop: 4 },
  momBox: { flexDirection: 'row', gap: 8, alignItems: 'center', paddingVertical: 10, marginTop: 6, borderTopWidth: 1, borderTopColor: '#F3F4F6' },
  momTxt: { fontSize: 12, color: '#374151' },

  ctaRow: { flexDirection: 'row', gap: 10, marginTop: 6, marginBottom: 20 },
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 14, borderRadius: 14 },
  actionTxt: { fontWeight: '800', fontSize: 14, color: '#111' },

  errBox: { alignItems: 'center', paddingVertical: 50, paddingHorizontal: 20 },
  errTitle: { fontSize: 14, fontWeight: '700', color: '#111', marginTop: 12, textAlign: 'center' },
