...
const useStyles = makeStyles((c) => ({
  ...
  lockBig: { width: 72, height: 72, borderRadius: 36, backgroundColor: 'rgba(245,110,30,0.18)', borderWidth: 2, borderColor: '#F56E1E', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  lockedTitle: { color: '#fff', fontSize: 18, fontWeight: '800', marginBottom: 6 },
  lockedBody: { color: '#D1D5DB', fontSize: 12.5, textAlign: 'center', lineHeight: 18, marginBottom: 18 },
  ...
  unlockTxt: { color: '#fff', fontSize: 14, fontWeight: '800' },

  // Active hero
  activeHero: { padding: 16, borderRadius: 18, marginBottom: 18 },
  activeHeroTop: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  diamondBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center' },
  activeTitle: { color: '#fff', fontSize: 16, fontWeight: '800' },
  activeSub: { color: '#FFE4CC', fontSize: 11, fontWeight: '700', marginTop: 2 },
  activeBody: { color: '#fff', fontSize: 12.5, marginTop: 10, opacity: 0.9 },

  sectionTitle: { fontSize: 12, fontWeight: '800', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 10, marginLeft: 2 },

  // Grid
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  tile: { width: '48%', backgroundColor: '#fff', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#F3F4F6', position: 'relative', overflow: 'hidden', minHeight: 130 },
  tileLocked: { backgroundColor: '#FAFAF9', borderColor: '#E5E7EB' },
  tileIcon: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  tileTitle: { fontSize: 13.5, fontWeight: '800', color: '#111', marginBottom: 4 },
  tileDesc: { fontSize: 11, color: '#6B7280', lineHeight: 15 },
  tileBadge: { position: 'absolute', top: 8, right: 8, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  tileBadgeTxt: { color: '#fff', fontSize: 9, fontWeight: '800', letterSpacing: 0.5 },
  lockOverlay: { position: 'absolute', top: 8, right: 8, width: 26, height: 26, borderRadius: 13, backgroundColor: '#FFFFFFE0', borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center', justifyContent: 'center' },
